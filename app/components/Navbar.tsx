...
export default function Navbar() {
  return (
    <header className="bg-background/80 dark:bg-background-dark/80 supports-backdrop-filter:bg-background/60 sticky top-0 z-50 w-full border-b border-gray-200/10 backdrop-blur-3xl">
